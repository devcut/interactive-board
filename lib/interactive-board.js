    ...
    _createClass(InteractiveBoard, [{
      ...
      value: function createShape(boardWidth, boardHeight) {
        ...
        var _loop = function _loop(i) {
          ...
          shape.setAttribute("data-position", i); // Set style of shape with config
      ...
      value: function activateRandomShape() {
        if (this.config.activateRandomShape.enabled) {
          ...
          setInterval(function () {
            var randomShape = Math.floor(1 + Math.random() * _this.boardElement.childElementCount);
            var child = document.querySelector("".concat(_this.config.board.element, " > div:nth-child(").concat(randomShape, ")"));
